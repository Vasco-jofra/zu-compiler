// $Id: basic_ast_visitor.h,v 1.9 2016/04/15 12:28:31 ist175219 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_function_return_node(zu::function_return_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_dereference_node(zu::dereference_node * const node, int lvl) = 0;
  virtual void do_reserve_memory_node(zu::reserve_memory_node * const node, int lvl) = 0;
};
